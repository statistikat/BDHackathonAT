...
germany <- person[RES_COUNTRY=="Germany"]
...
rm(person,res,res_int,lo,lo_int,sk,des_occ,des_occ_int,res_res,des_res_int,ed)
...
exp <- fread("/data/eures/JV data DWH 2016-11-30 CSV/JV_EXPERIENCE.csv")
